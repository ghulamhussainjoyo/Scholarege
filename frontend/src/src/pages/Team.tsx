...
const SocialIcons: FC = () => {
    return (
        <div className="social-icons flex gap-4">
            ...
            <button type="button" className="text-gray-400 bg-gray-200 hover:bg-orange-theme-royal-orange  hover:text-white focus:ring-4 focus:outline-none 
        focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800">
            ...
            <button type="button" className="text-gray-400 bg-gray-200 border hover:bg-orange-theme-royal-orange hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800">
                <BsGithub />
                <span className="sr-only">Icon description</span>
            </button>


            <button type="button" className="text-gray-400 bg-gray-200 border  hover:bg-orange-theme-royal-orange hover:text-white focus:ring-4 focus:outline-none 
        focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:focus:ring-blue-800">
                <BsFacebook />
                <span className="sr-only">Icon description</span>
            </button>
        ...
        <section className={`flex p-20 items-center justify-between flex-${flexDirection} gap-10`}>
            ...
            <div className='flex-1 flex flex-col gap-4'>
                ...
                <div className='Badges'>
                    <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">B.ed
                    </span>

                    <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">Default
                    </span>
...
const TeamSection2: FC<teamSection2> = ({ alignItems, name, description, education, skills, flexDirection, animationUrl, index }) => {
    return (
        <section className={`flex flex-col px-24 mx-10 py-10 mb-20 ${index === 0 ? 'bg-orange-theme-lavender' : ''}`}>
            ...
            <div className={`flex items-center justify-between mb-6 ${flexDirection}`}>
                ...
                <h1
                    className="text-4xl font-extrabold tracking-tighter  text-gray-900 md:text-7xl lg:text-9xl dark:text-white">
                    <span>{name.split(' ')[0]}</span>
                    <br />
                    <span>{name.split(' ')[1]}</span>
                </h1>
                <img
                    className="max-w-sm h-auto rounded-lg" src={require('../asset/images/ghulamhussain1.jpg')} alt="ghulam hussain" />
            </div>


            <div className={`flex flex-col gap-4 text-${alignItems}  items-${alignItems}`}>
                ...
                <div className='Badges'>

                    {
                        skills.map((skill, index) => (
                            <span key={index + Date.now().toString()} className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">{skill}
                            </span>
                        ))
                    }
...
const TeamSection3: FC = () => {
    return (
        <section className={`flex px-20 py-10 mb-20 gap-10 mx-10 rounded-md bg-orange-theme-lavender`}>

            <Card>
                <div className={`flex flex-col gap-4 text-center items-center justify-center `}>
                    <img className="max-w-xs h-auto rounded-lg" src={require('../asset/images/ghulamhussain1.jpg')} alt="ghulam hussain" />
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet porro natus autem consequuntur optio ut, excepturi quis vitae, reprehenderit totam nam iste repellat quo non atque, cupiditate illo. Necessitatibus, illum.
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus assumenda voluptatibus neque earum dolorum, aperiam labore tenetur in, minima minus quibusdam atque hic fugiat maiores deserunt adipisci id eum? Sunt?
                    </p>
                    ...
                    <header className='mb-28 mt-20 mx-32 4xl:mx-40'>
                        <section className='flex '>
                            <div className='flex gap-2 items-center -rotate-90 w-40 -ml-10'>
                                ...
                                />
                                <p className='text-gray-400 tracking-widest text-2xl'>inspiration</p>
                            </div>
                        ...
                        <section className='flex justify-end bg-orange-200'>
                            <h1 className="mb-4 text-4xl font-extrabold  leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white ">We <mark className="px-2 mb-10 text-white bg-orange-theme-royal-orange rounded dark:bg-blue-500">Stand</mark>
                                <br />
                                For Teams
                            </h1>
                        </section>
                        ...
                        <section className='flex items-center gap-4 '>
                            ...
                            <p className=''>
                                We Believe team can do remarkable work - when they actually get to work. The 60% of each we spend on email, Meeting, and status updates. That's is not it. It's Pushing boundries, solve problems, and making some thing reall.
                            </p>
                        </section>
                    </header>
