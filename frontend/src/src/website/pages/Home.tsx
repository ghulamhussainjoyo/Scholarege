...
import LinkRightDirection from "../components/others/LinkDirection";
import {
  HiArrowNarrowRight,
  HiArrowSmRight,
  HiLightBulb,
      ...
      <main className="sm:mx-14 md:mx-10 lg:mx-20 mx-5">
        ...
        <section className="home-scholarship sm:my-52">
          <section className="flex justify-between sm:mb-5">
            <div>
              <p className="text-orange-theme-royal-orange text 2xl:text-2xl">
                scholarships
              </p>
          ...
          <section className="flex flex-col sm:flex-row  gap-6 sm:justify-between">
            <div className="flex flex-col flex-[2] gap-3">
              <img
                ...
                src={require("../asset/images/medium-colleagues.jpg")}
                alt=""
              />
              ...
              <div className="sm:w-28 2xl:w-28 sm:mb-10">
                <Badge color={"gray"} icon={HiArrowSmRight} size="sm">
                  Intermeddiate
                </Badge>
              </div>
            ...
            <div className="flex-1">{<GetMostResecentArticle />}</div>
          </section>
        </section>

        {/* categories Section */}
        <section className="categories text-center rounded-md bg-orange-theme-cultered sm:my-52 my-20 pt-10">
          <p className="2xl:text-xl xl:text-lg lg:text-base text-sm text-orange-theme-royal-orange">
            Categories
          </p>
          <h1 className="2xl:text-6xl sm:text-3xl text-2xl text-orange-theme-dark-gunmetal font-extrabold capitalize">
        ...
        <section className="home-about-us sm:my-52 my-20">
          <div className="about-cards sm:gap-20 flex flex-col sm:flex-row">
            <section className="md:flex-[2] flex-[1]">
              ...
              <h1 className="2xl:text-6xl sm:text-3xl text-2xl text-orange-theme-dark-gunmetal font-extrabold capitalize mb-5">
                <span>
                  <span>Are you planning to study </span>
                  <span className="text-orange-theme-royal-orange">
                    abroad?
                  </span>
                </span>
              ...
              <p className="2xl:text-xl text-sm text-gray-400 mb-5">
                We have written the steps of guidance and professional tips.
                Find The StudyBaithak blog category where it is given you the
                best tips and recommendations related to your Journey of getting
                fully funded Scholarships and studying abroad.
              </p>
            ...
            <section className="relative md:flex-[1.5] sm:flex-[2] flex-[1.5]">
              <img
                ...
                src={require("../asset/images/students-with-laptop.jpg")}
                alt="quide-img"
              />
              <Link
                to={"/chilgoza"}
              ...
              >
                <BsFillPlayFill color="#ffff" size={30} />
              </Link>
            </section>
          </div>
        </section>
        ...
        <section className="home-about-us sm:my-24 my-20">
          <div className="flex flex-col justify-center items-center my-5 2xl:my-20">
            ...
            <h1 className="2xl:text-6xl sm:text-3xl text-2xl text-orange-theme-dark-gunmetal font-extrabold capitalize mb-5 text-center">
              Free{" "}
              <span className="text-orange-theme-royal-orange">
                Scholarship
              </span>
