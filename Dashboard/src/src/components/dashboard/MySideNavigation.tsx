...
function MySideNavigation() {
    ...
    return (
        <section className="fixed top-0 left-0 w-64 h-full bg-red-500" aria-label="Sidenav">
            ...
            <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul className="space-y-2">
                    ...
                    <li>
                        <Link to="/" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            onMouseOver={() => setIsMouseHover({ ...isMouseHover, create: true })}
                            onMouseOut={() => setIsMouseHover({ ...isMouseHover, create: false })}
                        >
                            <IoIosCreate size={24}
                                className={`${isMouseHover.create ? 'text-gray-700 opacity-100' : 'text-gray-400 opacity-90'} transition-all duration-300`}
                            />
                    ...
                    <li>
                        <Link to="/" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            onMouseOver={() => setIsMouseHover({ ...isMouseHover, posts: true })}
                            onMouseOut={() => setIsMouseHover({ ...isMouseHover, posts: false })}
                        >
                            <BsFilePost size={24}
                                className={`${isMouseHover.posts ? 'text-gray-700 opacity-100' : 'text-gray-400 opacity-90'} transition-all duration-300`}
                            />
                ...
                <ul className="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                    <li>
                        <Link to="/" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            onMouseOver={() => setIsMouseHover({ ...isMouseHover, docs: true })}
                            onMouseOut={() => setIsMouseHover({ ...isMouseHover, docs: false })}
                        >
                            <HiDocument size={24}
                                className={`${isMouseHover.docs ? 'text-gray-700 opacity-100' : 'text-gray-400 opacity-90'} transition-all duration-300`}
                            />
                    ...
                    <li>
                        <Link to="/" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            onMouseOver={() => setIsMouseHover({ ...isMouseHover, component: true })}
                            onMouseOut={() => setIsMouseHover({ ...isMouseHover, component: false })}
                        >
                            <HiRectangleStack
                                size={24}
                                className={`${isMouseHover.component ? 'text-gray-700 opacity-100' : 'text-gray-400 opacity-90'} transition-all duration-300`}
                            />
